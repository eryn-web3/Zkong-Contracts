...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.nkt = await MockBEP20.deployed();
        ...
        await this.nkt.transfer(bob, '2000', { from: minter });
        await this.nkt.transfer(alice, '2000', { from: minter });
        await this.nkt.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.nkt.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.nkt.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.nkt.balanceOf(this.lotteryProxyAddress)).toString(), '418');
